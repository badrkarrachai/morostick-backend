...
export const getCategoryTabsByNames = async (categoryNames: string[]): Promise<CategoryView[]> => {
  ...
  const orderedCategories = categoryNames.reduce((ordered: CategoryView[], name) => {
