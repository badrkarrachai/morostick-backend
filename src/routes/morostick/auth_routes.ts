...
import { requestPasswordReset, resetPassword } from "../../controllers/auth_controllers/reset_password_controller";
...
router.post("/reset-password-request", rateLimiterGeneral, requestPasswordReset);
